...
opaque getGlobalSize (dimindx : UInt32) : OpenCLM USize
...
opaque getGlobalId (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getGlobalId dimindx ==> get_global_id(dimindx)
...
opaque getLocalSize (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getLocalSize dimindx ==> get_local_size(dimindx)
...
opaque getEnqueuedLocalSize (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getEnqueuedLocalSize dimindx ==> get_enqueued_local_size(dimindx)
...
opaque getLocalId (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getLocalId dimindx ==> get_local_id(dimindx)
...
opaque getNumGroups (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getNumGroups dimindx ==> get_num_groups(dimindx)
...
opaque getGroupId (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getGroupId dimindx ==> get_group_id(dimindx)
...
opaque getGlobalOffset (dimindx : UInt32) : OpenCLM USize
impl_by (dimindx : UInt32) : getGlobalOffset dimindx ==> get_global_offset(dimindx)
...
opaque getGlobalLinearId : OpenCLM USize
impl_by : getGlobalLinearId ==> get_global_linear_id()
...
opaque getLocalLinearId : OpenCLM USize
impl_by : getLocalLinearId ==> get_local_linear_id()
...
impl_by : getSubGroupSize ==> get_sub_group_size()
...
impl_by : getMaxSubGroupSize ==> get_max_sub_group_size()
...
impl_by : getNumSubGroups ==> get_num_sub_groups()
...
impl_by : getEnqueuedNumSubGroups ==> get_enqueued_num_sub_groups()
...
impl_by : getSubGroupId ==> get_sub_group_id()
...
impl_by : getSubGroupLocalId ==> get_sub_group_local_id()
