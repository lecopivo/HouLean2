...
noncomputable
def add.apex_impl (a b : Matrix4) : Matrix4 := AddMatrix4 a #v[b]

attribute [apex_implemented_by HouLean.Matrix4.add.apex_impl] add

noncomputable
def sub.apex_impl (a b : Matrix4) : Matrix4 := SubtractMatrix4 a #v[b]

attribute [apex_implemented_by HouLean.Matrix4.sub.apex_impl] sub

noncomputable
def mul.apex_impl (a b : Matrix4) : Matrix4 := MultiplyMatrix4 a #v[b]

attribute [apex_implemented_by HouLean.Matrix4.mul.apex_impl] mul

noncomputable
def mulScalar.apex_impl (a : Matrix4) (s : Float) : Matrix4 := MultiplyMatrix4Float a #v[s]

attribute [apex_implemented_by HouLean.Matrix4.mulScalar.apex_impl] mulScalar

noncomputable
def mulMatrix3.apex_impl (a : Matrix4) (b : Matrix3) : Matrix4 := MultiplyMatrix4Matrix3 a #v[b]

attribute [apex_implemented_by HouLean.Matrix4.mulMatrix3.apex_impl] mulMatrix3

noncomputable
def mulVector3.apex_impl (v : Vector3) (m : Matrix4) : Vector3 := MultiplyVector3Matrix4 v #v[m]

attribute [apex_implemented_by HouLean.Matrix4.mulVector3.apex_impl] mulVector3

noncomputable
def mulVector4.apex_impl (v : Vector4) (m : Matrix4) : Vector4 := MultiplyVector4Matrix4 v #v[m]
