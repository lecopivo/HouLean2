...
--   let a3 := toMatrix3 a
--   let b3 := toMatrix3 b
--   fromMatrix3 (AddMatrix3 a3 #a[b3])
...
--   let a3 := toMatrix3 a
--   let b3 := toMatrix3 b
--   fromMatrix3 (SubtractMatrix3 a3 #a[b3])
...
--   let a3 := toMatrix3 a
--   let b3 := toMatrix3 b
--   fromMatrix3 (MultiplyMatrix3 a3 #a[b3])
...
--   let a3 := toMatrix3 a
--   fromMatrix3 (MultiplyMatrix3Float a3 #a[s])
...
--   let v3 := ⟨v.x, v.y, 0⟩
--   let m3 := toMatrix3 m
--   let result := MultiplyVector3Matrix3 v3 #a[m3]
--   ⟨result.x, result.y⟩
