...
-- @[apex_node "ComponentIntToBools"]        
-- opaque ComponentIntToBools (entries : Int) (use_t : Bool) (use...
...
-- special function not supported yet
-- @[apex_node "ExtractCharacterGraph"]        
-- opaque ExtractCharacterGraph (input : String) (find : String...

-- special function not supported yet
-- @[apex_node "FindCharacterElement" has_rundata]        
-- opaque FindCharacterElement (geo0 : Geometry) (pa...

-- special function not supported yet
-- @[apex_node "FindOrCreateCharacterGraph"]        
-- opaque FindOrCreateCharacterGraph (parm : Int) (input :...

-- special function not supported yet
-- @[apex_node "FindPackedGeo"]        
-- opaque FindPackedGeo (input : String) (find : String) (replace : Str...
...
-- opaque ForBegin (iterations : Int) (__spare__ : undefined) : ...

-- special function not supported yet
-- @[apex_node "ForEachBegin<ApexNodeID>" has_rundata]        
-- opaque ForEachBegin<ApexNodeID> (array : Apex...

-- special function not supported yet
-- @[apex_node "ForEachBegin<ApexPortID>" has_rundata]        
-- opaque ForEachBegin<ApexPortID> (array : Apex...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Bool>" has_rundata]        
-- opaque ForEachBegin<Bool> (array : BoolArray) (__sp...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Dict>" has_rundata]        
-- opaque ForEachBegin<Dict> (array : DictArray) (__sp...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Float>" has_rundata]        
-- opaque ForEachBegin<Float> (array : FloatArray) (_...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Geometry>" has_rundata]        
-- opaque ForEachBegin<Geometry> (array : Geometry...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Int>" has_rundata]        
-- opaque ForEachBegin<Int> (array : IntArray) (__spare...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Matrix3>" has_rundata]        
-- opaque ForEachBegin<Matrix3> (array : Matrix3Arr...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Matrix4>" has_rundata]        
-- opaque ForEachBegin<Matrix4> (array : Matrix4Arr...

-- special function not supported yet
-- @[apex_node "ForEachBegin<String>" has_rundata]        
-- opaque ForEachBegin<String> (array : StringArray)...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Vector2>" has_rundata]        
-- opaque ForEachBegin<Vector2> (array : Vector2Arr...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Vector3>" has_rundata]        
-- opaque ForEachBegin<Vector3> (array : Vector3Arr...

-- special function not supported yet
-- @[apex_node "ForEachBegin<Vector4>" has_rundata]        
-- opaque ForEachBegin<Vector4> (array : Vector4Arr...

-- special function not supported yet
-- @[apex_node "ForEachEnd<ApexNodeID>" has_rundata]        
-- opaque ForEachEnd<ApexNodeID> (scope : undefine...

-- special function not supported yet
-- @[apex_node "ForEachEnd<ApexPortID>" has_rundata]        
-- opaque ForEachEnd<ApexPortID> (scope : undefine...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Bool>" has_rundata]        
-- opaque ForEachEnd<Bool> (scope : undefined) (array : ...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Dict>" has_rundata]        
-- opaque ForEachEnd<Dict> (scope : undefined) (array : ...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Float>" has_rundata]        
-- opaque ForEachEnd<Float> (scope : undefined) (array ...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Geometry>" has_rundata]        
-- opaque ForEachEnd<Geometry> (scope : undefined) (...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Int>" has_rundata]        
-- opaque ForEachEnd<Int> (scope : undefined) (array : In...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Matrix3>" has_rundata]        
-- opaque ForEachEnd<Matrix3> (scope : undefined) (ar...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Matrix4>" has_rundata]        
-- opaque ForEachEnd<Matrix4> (scope : undefined) (ar...

-- special function not supported yet
-- @[apex_node "ForEachEnd<String>" has_rundata]        
-- opaque ForEachEnd<String> (scope : undefined) (arra...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Vector2>" has_rundata]        
-- opaque ForEachEnd<Vector2> (scope : undefined) (ar...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Vector3>" has_rundata]        
-- opaque ForEachEnd<Vector3> (scope : undefined) (ar...

-- special function not supported yet
-- @[apex_node "ForEachEnd<Vector4>" has_rundata]        
-- opaque ForEachEnd<Vector4> (scope : undefined) (ar...

-- special function not supported yet
-- @[apex_node "ForEnd" has_rundata]        
-- opaque ForEnd (scope : undefined) (__spare__ : undefined) : und...
...
-- opaque IfBegin (condition : Bool) (__spare__ : undefined) : un...

-- special function not supported yet
-- @[apex_node "IfEnd" has_rundata]        
-- opaque IfEnd (scope : undefined) (__spare__ : undefined) : undef...

-- special function not supported yet
-- @[apex_node "IntBitMaskToBool::2.0"]        
-- opaque IntBitMaskToBool::2.0 (entries : Int) : VariadicArg B...
...
-- special function not supported yet
-- @[apex_node "Log" has_rundata]        
-- opaque Log (args0 : undefined) (severity : Int) (formatstring : St...
...
-- special function not supported yet
-- @[apex_node "Null<geo::IntersectCache>"]        
-- opaque Null<geo::IntersectCache> (value : geo::Intersect...
...
-- special function not supported yet
-- @[apex_node "RunVex" has_rundata]        
-- opaque RunVex (snippet : String) {numinputs: Nat} (inputs : Var...
...
-- special function not supported yet
-- @[apex_node "UpdateCharacterElement"]        
-- opaque UpdateCharacterElement (input : String) (separators ...

-- special function not supported yet
-- @[apex_node "UpdateCharacterGraph"]        
-- opaque UpdateCharacterGraph (input : Bool) (condition : Bool)...

-- special function not supported yet
-- @[apex_node "UpdateNodeTags" has_rundata]        
-- opaque UpdateNodeTags (graph : ApexGraphHandle) (nodeid...
...
-- special function not supported yet
-- @[apex_node "ch::AnimStackEvaluate" has_rundata]        
-- opaque ch::AnimStackEvaluate (animstack : AnimSt...
...
-- special function not supported yet
-- @[apex_node "ch::ChannelsFromCollection"]        
-- opaque ch::ChannelsFromCollection (channels : AnimChann...

-- special function not supported yet
-- @[apex_node "ch::ChannelsFromPrims" has_rundata]        
-- opaque ch::ChannelsFromPrims (geo : Geometry) : ...
...
-- special function not supported yet
-- @[apex_node "component::AddAbstractControl"]        
-- opaque component::AddAbstractControl (value : ApexGr...

-- special function not supported yet
-- @[apex_node "component::AddColorScheme"]        
-- opaque component::AddColorScheme (value : ApexGraphHandl...

-- special function not supported yet
-- @[apex_node "component::AddConfigControl"]        
-- opaque component::AddConfigControl (parm : String) (pa...

-- special function not supported yet
-- @[apex_node "component::AddControlAction"]        
-- opaque component::AddControlAction (parm : String) (pa...

-- special function not supported yet
-- @[apex_node "component::AddControlGroup"]        
-- opaque component::AddControlGroup (parm : ApexGraphHand...

-- special function not supported yet
-- @[apex_node "component::AddControlGroupPrimary" has_rundata]        
-- opaque component::AddControlGroupPri...

-- special function not supported yet
-- @[apex_node "component::AddLodControls"]        
-- opaque component::AddLodControls (parm : Float) (parm : ...

-- special function not supported yet
-- @[apex_node "component::AddSpaceSwitchControl"]        
-- opaque component::AddSpaceSwitchControl (parm : D...

-- special function not supported yet
-- @[apex_node "component::Blendshape"]        
-- opaque component::Blendshape (parm : String) (parm : ApexNod...

-- special function not supported yet
-- @[apex_node "component::Bonedeform"]        
-- opaque component::Bonedeform (parm : Dict) (parm : Int) (val...

-- special function not supported yet
-- @[apex_node "component::Deltamush"]        
-- opaque component::Deltamush (graph : ApexGraphHandle) (name :...

-- special function not supported yet
-- @[apex_node "component::FBIK"]        
-- opaque component::FBIK (parm : String) (parm : Dict) (value : Apex...

-- special function not supported yet
-- @[apex_node "component::FKIK"]        
-- opaque component::FKIK (value : String) (input : String) (separato...

-- special function not supported yet
-- @[apex_node "component::FindSegments"]        
-- opaque component::FindSegments (parm : StringArray) (value...

-- special function not supported yet
-- @[apex_node "component::GetRestTransform" has_rundata]        
-- opaque component::GetRestTransform (condit...

-- special function not supported yet
-- @[apex_node "component::GetRig"]        
-- opaque component::GetRig (value : Geometry) (value : String) (va...

-- special function not supported yet
-- @[apex_node "component::GetTransformChildren" has_rundata]        
-- opaque component::GetTransformChildren...

-- special function not supported yet
-- @[apex_node "component::GetTransformDescendants" has_rundata]        
-- opaque component::GetTransformDesce...

-- special function not supported yet
-- @[apex_node "component::GetTransformParent" has_rundata]        
-- opaque component::GetTransformParent (in...

-- special function not supported yet
-- @[apex_node "component::InsertTransformParent" has_rundata]        
-- opaque component::InsertTransformPare...

-- special function not supported yet
-- @[apex_node "component::Lookat" has_rundata]        
-- opaque component::Lookat (next : undefined) {numentr...

-- special function not supported yet
-- @[apex_node "component::MappedConstraints"]        
-- opaque component::MappedConstraints (value : ApexGrap...

-- special function not supported yet
-- @[apex_node "component::MultiIk"]        
-- opaque component::MultiIk (value : ApexGraphHandle) (value : Ge...

-- special function not supported yet
-- @[apex_node "component::MultiIk::2.0"]        
-- opaque component::MultiIk::2.0 (value : ApexGraphHandle) (...

-- special function not supported yet
-- @[apex_node "component::ProcessSegment"]        
-- opaque component::ProcessSegment (value : String) (value...

-- special function not supported yet
-- @[apex_node "component::Rename"]        
-- opaque component::Rename (parm : String) (parm : String) (parm :...

-- special function not supported yet
-- @[apex_node "component::ReverseFoot"]        
-- opaque component::ReverseFoot (value : ApexGraphHandle) (va...

-- special function not supported yet
-- @[apex_node "component::ReverseFoot::2.0"]        
-- opaque component::ReverseFoot::2.0 (value : ApexGraphH...

-- special function not supported yet
-- @[apex_node "component::SetRestTransform"]        
-- opaque component::SetRestTransform (graph : ApexGraphH...

-- special function not supported yet
-- @[apex_node "component::SetRestTransformFromSkel" has_rundata]        
-- opaque component::SetRestTransform...

-- special function not supported yet
-- @[apex_node "component::SetTransformParent" has_rundata]        
-- opaque component::SetTransformParent (gr...

-- special function not supported yet
-- @[apex_node "component::Spline"]        
-- opaque component::Spline (parm : StringArray) (value : ApexGraph...

-- special function not supported yet
-- @[apex_node "component::Spline2"]        
-- opaque component::Spline2 (parm : StringArray) (parm : StringAr...

-- special function not supported yet
-- @[apex_node "component::Spline::2.0"]        
-- opaque component::Spline::2.0 (parm : StringArray) (parm : ...

-- special function not supported yet
-- @[apex_node "component::TransformDriver"]        
-- opaque component::TransformDriver (array : DictArray) (...

-- special function not supported yet
-- @[apex_node "component::Twist"]        
-- opaque component::Twist (parm : ApexNodeIDArray) (parm : String) ...

-- special function not supported yet
-- @[apex_node "component::UpdateControls"]        
-- opaque component::UpdateControls (value : ApexGraphHandl...

-- special function not supported yet
-- @[apex_node "component::UpdateParmLimits"]        
-- opaque component::UpdateParmLimits (parm : String) (pa...

-- special function not supported yet
-- @[apex_node "component::UpdateRig"]        
-- opaque component::UpdateRig (parm : Dict) (parm : String) (pa...

-- special function not supported yet
-- @[apex_node "componentgadget::ReferenceSkeleton"]        
-- opaque componentgadget::ReferenceSkeleton (valu...

-- special function not supported yet
-- @[apex_node "controldrawable::SkinControl"]        
-- opaque controldrawable::SkinControl (parm : String) (...
...
-- special function not supported yet
-- @[apex_node "controlgadget::ClosestRayJoint"]        
-- opaque controlgadget::ClosestRayJoint (parm : Float...

-- special function not supported yet
-- @[apex_node "controlgadget::MultiXformGadget"]        
-- opaque controlgadget::MultiXformGadget (parm : Int...

-- special function not supported yet
-- @[apex_node "controlgadget::SnapXFormToAxes"]        
-- opaque controlgadget::SnapXFormToAxes (parm : Float...

-- special function not supported yet
-- @[apex_node "controlgadget::TagJointVisualizer"]        
-- opaque controlgadget::TagJointVisualizer (parm :...

-- special function not supported yet
-- @[apex_node "controlgadget::TwistJointVisualizer"]        
-- opaque controlgadget::TwistJointVisualizer (pa...
...
-- special function not supported yet
-- @[apex_node "cop::average<0>" has_rundata]        
-- opaque cop::average<0> {numinput_variadic_geo: Nat} (i...

-- special function not supported yet
-- @[apex_node "cop::average<1>" has_rundata]        
-- opaque cop::average<1> {numinput_variadic_geo: Nat} (i...
...
-- special function not supported yet
-- @[apex_node "cop::contactsheet" has_rundata]        
-- opaque cop::contactsheet {numinput_variadic_geo: Nat...
...
-- special function not supported yet
-- @[apex_node "cop::cryptomatte" has_rundata]        
-- opaque cop::cryptomatte (crypto1_0 : ImageLayer) {num...
...
-- special function not supported yet
-- @[apex_node "cop::file" has_rundata]        
-- opaque cop::file (signature : StringArray) (cwd_node : Strin...
...
-- special function not supported yet
-- @[apex_node "cop::geotolayer::2.0" has_rundata]        
-- opaque cop::geotolayer::2.0 (geometry_0 : Geometr...
...
-- special function not supported yet
-- @[apex_node "cop::invokeblock" has_rundata]        
-- opaque cop::invokeblock {numinput_variadic_geo: Nat} ...

-- special function not supported yet
-- @[apex_node "cop::invokegeo" has_rundata]        
-- opaque cop::invokegeo (input1_0 : Geometry) {numinput_v...
...
-- special function not supported yet
-- @[apex_node "cop::livevideo" has_rundata]        
-- opaque cop::livevideo (signature : StringArray) (cwd_no...
...
-- special function not supported yet
-- @[apex_node "cop::onnx" has_rundata]        
-- opaque cop::onnx (input1_0 : ImageLayer) {numinput_variadic_...

-- special function not supported yet
-- @[apex_node "cop::opencl" has_rundata]        
-- opaque cop::opencl {numinput_variadic_geo: Nat} (input_var...
...
-- special function not supported yet
-- @[apex_node "cop::pythonsnippet" has_rundata]        
-- opaque cop::pythonsnippet {numinput_variadic_geo: N...
...
-- special function not supported yet
-- @[apex_node "cop::rasterizecurves" has_rundata]        
-- opaque cop::rasterizecurves (camera_ref_0 : Image...

-- special function not supported yet
-- @[apex_node "cop::rasterizegeo" has_rundata]        
-- opaque cop::rasterizegeo (camera_ref_0 : ImageLayer)...
...
-- special function not supported yet
-- @[apex_node "cop::raytrace" has_rundata]        
-- opaque cop::raytrace (geometry_0 : Geometry) (origins_1 ...
...
-- special function not supported yet
-- @[apex_node "cop::sequenceblend" has_rundata]        
-- opaque cop::sequenceblend (blend_0 : ImageLayer) (i...

-- special function not supported yet
-- @[apex_node "cop::slapcompimport" has_rundata]        
-- opaque cop::slapcompimport {numinput_variadic_geo:...
...
-- special function not supported yet
-- @[apex_node "cop::sopinvoke" has_rundata]        
-- opaque cop::sopinvoke {numinput_variadic_geo: Nat} (inp...

-- special function not supported yet
-- @[apex_node "cop::sopinvokegraph" has_rundata]        
-- opaque cop::sopinvokegraph (graph_0 : Geometry) {n...

-- special function not supported yet
-- @[apex_node "cop::stamppoint" has_rundata]        
-- opaque cop::stamppoint (size_ref_0 : ImageLayer) (poin...
...
-- special function not supported yet
-- @[apex_node "cop::switch<0>" has_rundata]        
-- opaque cop::switch<0> {numinput_variadic_geo: Nat} (inp...

-- special function not supported yet
-- @[apex_node "cop::switch<1>" has_rundata]        
-- opaque cop::switch<1> {numinput_variadic_geo: Nat} (inp...

-- special function not supported yet
-- @[apex_node "cop::switch<2>" has_rundata]        
-- opaque cop::switch<2> {numinput_variadic_geo: Nat} (inp...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<0>" has_rundata]        
-- opaque cop::switchbytype<0> (type_ref_0 : ImageLa...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<1>" has_rundata]        
-- opaque cop::switchbytype<1> (type_ref_0 : ImageLa...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<2>" has_rundata]        
-- opaque cop::switchbytype<2> (type_ref_0 : Geometr...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<3>" has_rundata]        
-- opaque cop::switchbytype<3> (type_ref_0 : Geometr...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<4>" has_rundata]        
-- opaque cop::switchbytype<4> (type_ref_0 : NanoVDB...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<5>" has_rundata]        
-- opaque cop::switchbytype<5> (type_ref_0 : NanoVDB...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<6>" has_rundata]        
-- opaque cop::switchbytype<6> (type_ref_0 : NanoVDB...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<7>" has_rundata]        
-- opaque cop::switchbytype<7> (type_ref_0 : ImageLa...

-- special function not supported yet
-- @[apex_node "cop::switchbytype<8>" has_rundata]        
-- opaque cop::switchbytype<8> (type_ref_0 : Geometr...

-- special function not supported yet
-- @[apex_node "cop::switchifwired<0>" has_rundata]        
-- opaque cop::switchifwired<0> {numinput_variadic_...

-- special function not supported yet
-- @[apex_node "cop::switchifwired<1>" has_rundata]        
-- opaque cop::switchifwired<1> {numinput_variadic_...

-- special function not supported yet
-- @[apex_node "cop::switchifwired<2>" has_rundata]        
-- opaque cop::switchifwired<2> {numinput_variadic_...
...
-- special function not supported yet
-- @[apex_node "cop::vdbactivatefrompoints" has_rundata]        
-- opaque cop::vdbactivatefrompoints (refvdb_0...
...
-- special function not supported yet
-- @[apex_node "cop::wrangle" has_rundata]        
-- opaque cop::wrangle {numinput_variadic_geo: Nat} (input_v...
...
-- special function not supported yet
-- @[apex_node "dict::Extract" has_rundata]        
...
-- special function not supported yet
-- @[apex_node "dynamicpath::LoadFromGraph" has_rundata]        
-- opaque dynamicpath::LoadFromGraph (graph : ...

-- special function not supported yet
-- @[apex_node "dynamicpath::LoadFromGraphChannels" has_rundata]        
-- opaque dynamicpath::LoadFromGraphCh...
...
-- special function not supported yet
-- @[apex_node "geo::AttribIntersectPoints" has_rundata]        
-- opaque geo::AttribIntersectPoints (geo : Ge...
...
-- special function not supported yet
-- @[apex_node "geo::ForEachPointBegin" has_rundata]        
-- opaque geo::ForEachPointBegin (geo : Geometry) ...

-- special function not supported yet
-- @[apex_node "geo::ForEachPointEnd" has_rundata]        
-- opaque geo::ForEachPointEnd (scope : undefined) (...

-- special function not supported yet
-- @[apex_node "geo::ForEachPrimBegin" has_rundata]        
-- opaque geo::ForEachPrimBegin (geo : Geometry) (g...

-- special function not supported yet
-- @[apex_node "geo::ForEachPrimEnd" has_rundata]        
-- opaque geo::ForEachPrimEnd (scope : undefined) (ge...
...
-- special function not supported yet
-- @[apex_node "geo::InitIntersectCache"]        
-- opaque geo::InitIntersectCache (geo : Geometry) : Geometry...

-- special function not supported yet
-- @[apex_node "geo::Intersect"]        
-- opaque geo::Intersect (intersect_cache : geo::IntersectCache) (orig...

-- special function not supported yet
-- @[apex_node "geo::IntersectPoints" has_rundata]        
-- opaque geo::IntersectPoints (intersect_cache : ge...
...
-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Dict>" has_rundata]        
-- opaque geo::PointAttribValuesByName...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<DictArray>" has_rundata]        
-- opaque geo::PointAttribValuesB...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Float>" has_rundata]        
-- opaque geo::PointAttribValuesByNam...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<FloatArray>" has_rundata]        
-- opaque geo::PointAttribValues...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Int>" has_rundata]        
-- opaque geo::PointAttribValuesByName<...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<IntArray>" has_rundata]        
-- opaque geo::PointAttribValuesBy...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Matrix3>" has_rundata]        
-- opaque geo::PointAttribValuesByN...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Matrix4>" has_rundata]        
-- opaque geo::PointAttribValuesByN...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<String>" has_rundata]        
-- opaque geo::PointAttribValuesByNa...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<StringArray>" has_rundata]        
-- opaque geo::PointAttribValue...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Vector2>" has_rundata]        
-- opaque geo::PointAttribValuesByN...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Vector3>" has_rundata]        
-- opaque geo::PointAttribValuesByN...

-- special function not supported yet
-- @[apex_node "geo::PointAttribValuesByName<Vector4>" has_rundata]        
-- opaque geo::PointAttribValuesByN...
...
-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Dict>" has_rundata]        
-- opaque geo::PrimAttribValuesByName<D...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<DictArray>" has_rundata]        
-- opaque geo::PrimAttribValuesByN...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Float>" has_rundata]        
-- opaque geo::PrimAttribValuesByName<...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<FloatArray>" has_rundata]        
-- opaque geo::PrimAttribValuesBy...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Int>" has_rundata]        
-- opaque geo::PrimAttribValuesByName<In...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<IntArray>" has_rundata]        
-- opaque geo::PrimAttribValuesByNa...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Matrix3>" has_rundata]        
-- opaque geo::PrimAttribValuesByNam...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Matrix4>" has_rundata]        
-- opaque geo::PrimAttribValuesByNam...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<String>" has_rundata]        
-- opaque geo::PrimAttribValuesByName...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<StringArray>" has_rundata]        
-- opaque geo::PrimAttribValuesB...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Vector2>" has_rundata]        
-- opaque geo::PrimAttribValuesByNam...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Vector3>" has_rundata]        
-- opaque geo::PrimAttribValuesByNam...

-- special function not supported yet
-- @[apex_node "geo::PrimAttribValuesByName<Vector4>" has_rundata]        
-- opaque geo::PrimAttribValuesByNam...
...
-- special function not supported yet
-- @[apex_node "geo::UnpackAndTransform" has_rundata]        
-- opaque geo::UnpackAndTransform (geo0 : Geometr...
...
-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Dict>" has_rundata]        
-- opaque geo::VertexAttribValuesByNa...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<DictArray>" has_rundata]        
-- opaque geo::VertexAttribValue...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Float>" has_rundata]        
-- opaque geo::VertexAttribValuesByN...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<FloatArray>" has_rundata]        
-- opaque geo::VertexAttribValu...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Int>" has_rundata]        
-- opaque geo::VertexAttribValuesByNam...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<IntArray>" has_rundata]        
-- opaque geo::VertexAttribValues...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Matrix3>" has_rundata]        
-- opaque geo::VertexAttribValuesB...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Matrix4>" has_rundata]        
-- opaque geo::VertexAttribValuesB...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<String>" has_rundata]        
-- opaque geo::VertexAttribValuesBy...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<StringArray>" has_rundata]        
-- opaque geo::VertexAttribVal...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Vector2>" has_rundata]        
-- opaque geo::VertexAttribValuesB...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Vector3>" has_rundata]        
-- opaque geo::VertexAttribValuesB...

-- special function not supported yet
-- @[apex_node "geo::VertexAttribValuesByName<Vector4>" has_rundata]        
-- opaque geo::VertexAttribValuesB...

-- special function not supported yet
-- @[apex_node "geoutils::AttributeDelete"]        
-- opaque geoutils::AttributeDelete (value : Geometry) (val...

-- special function not supported yet
-- @[apex_node "geoutils::CopyToPointsTargetAttribs"]        
-- opaque geoutils::CopyToPointsTargetAttribs (pa...

-- special function not supported yet
-- @[apex_node "geoutils::DottedLine"]        
-- opaque geoutils::DottedLine (parm : Int) (parm : Int) (parm :...

-- special function not supported yet
-- @[apex_node "geoutils::GhostedGeo"]        
-- opaque geoutils::GhostedGeo (value : Geometry) (value : Vecto...

-- special function not supported yet
-- @[apex_node "geoutils::SimpleArrow" has_rundata]        
-- opaque geoutils::SimpleArrow (type : Int) (origi...
...
-- special function not supported yet
-- @[apex_node "geoutils::Wrangle"]        
-- opaque geoutils::Wrangle (value : Geometry) (value : Geometry) (...
...
-- special function not supported yet
-- @[apex_node "graph::DuplicateNode" has_rundata]        
-- opaque graph::DuplicateNode (graph : ApexGraphHan...

-- special function not supported yet
-- @[apex_node "graph::EvaluateOutputs" has_rundata]        
-- opaque graph::EvaluateOutputs (graph : ApexGrap...
...
-- special function not supported yet
-- @[apex_node "graph::FindNodeTags"]        
-- opaque graph::FindNodeTags (parm : String) (graph : ApexGraphH...
...
-- special function not supported yet
-- @[apex_node "graph::HasNodeTag"]        
-- opaque graph::HasNodeTag (parm : String) (graph : ApexGraphHandl...

-- special function not supported yet
-- @[apex_node "graph::HasNodeTags" has_rundata]        
-- opaque graph::HasNodeTags (array : StringArray) (__...
...
-- special function not supported yet
-- @[apex_node "graph::Invoke" has_rundata]        
-- opaque graph::Invoke (graph : ApexGraphHandle) (outputs ...

-- special function not supported yet
-- @[apex_node "graph::IsConnected" has_rundata]        
-- opaque graph::IsConnected (input : void) (checkdefa...
...
-- special function not supported yet
-- @[apex_node "graph::PromoteNodeInput"]        
-- opaque graph::PromoteNodeInput (input : String) (separator...

-- special function not supported yet
-- @[apex_node "graph::PromoteNodeInputs"]        
-- opaque graph::PromoteNodeInputs (graph : ApexGraphHandle)...

-- special function not supported yet
-- @[apex_node "graph::PromoteNodeOutput"]        
-- opaque graph::PromoteNodeOutput (input : String) (separat...

-- special function not supported yet
-- @[apex_node "graph::PromoteNodeOutputs" has_rundata]        
-- opaque graph::PromoteNodeOutputs (input : Ap...
...
-- special function not supported yet
-- @[apex_node "graph::PromotePort"]        
-- opaque graph::PromotePort (parm : String) (graph : ApexGraphHan...
...
-- special function not supported yet
-- @[apex_node "graph::ReplaceNodeTag"]        
-- opaque graph::ReplaceNodeTag (graph : ApexGraphHandle) (node...
...
-- special function not supported yet
-- @[apex_node "guide::AddSetPointTransforms"]        
-- opaque guide::AddSetPointTransforms (value : ApexGrap...

-- special function not supported yet
-- @[apex_node "guide::ControlsFromGuides"]        
-- opaque guide::ControlsFromGuides (value : ApexGraphHandl...

-- special function not supported yet
-- @[apex_node "guide::ExtractGuides"]        
-- opaque guide::ExtractGuides (input : String) (find : String) ...

-- special function not supported yet
-- @[apex_node "guide::FindOrAddGuide"]        
-- opaque guide::FindOrAddGuide (value : Geometry) (value : Str...

-- special function not supported yet
-- @[apex_node "guide::FindPrimaryAxis"]        
-- opaque guide::FindPrimaryAxis (parm : Vector3) (parm : Vect...

-- special function not supported yet
-- @[apex_node "guide::SetGuideParent"]        
-- opaque guide::SetGuideParent (parm : String) (value : ApexGr...

-- special function not supported yet
-- @[apex_node "guide::SetGuideProperties"]        
-- opaque guide::SetGuideProperties (value : Geometry) (val...

-- special function not supported yet
-- @[apex_node "guide::UpdateGuides"]        
-- opaque guide::UpdateGuides (input : Bool) (condition : Bool) (...

-- special function not supported yet
-- @[apex_node "guide::UpdatePatternFromGuides"]        
-- opaque guide::UpdatePatternFromGuides (parm : Strin...

-- special function not supported yet
-- @[apex_node "guide::UpdateShapesFromGuides"]        
-- opaque guide::UpdateShapesFromGuides (value : ApexGr...

-- special function not supported yet
-- @[apex_node "guidecomponent::Add2BoneIK"]        
-- opaque guidecomponent::Add2BoneIK (parm : StringArray) ...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddComponentControl"]        
-- opaque guidecomponent::AddComponentControl (pa...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddComponentLimb"]        
-- opaque guidecomponent::AddComponentLimb (x : Floa...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddComponentRoot"]        
-- opaque guidecomponent::AddComponentRoot (parm : V...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddComponentSkeleton"]        
-- opaque guidecomponent::AddComponentSkeleton (...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddComponentSpline"]        
-- opaque guidecomponent::AddComponentSpline (parm...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddComponentTag"]        
-- opaque guidecomponent::AddComponentTag (value : Ge...

-- special function not supported yet
-- @[apex_node "guidecomponent::AddSegmentControl"]        
-- opaque guidecomponent::AddSegmentControl (parm :...

-- special function not supported yet
-- @[apex_node "guidecomponent::MirrorGuideControls"]        
-- opaque guidecomponent::MirrorGuideControls (pa...

-- special function not supported yet
-- @[apex_node "guidecomponent::SkeletonToFK"]        
-- opaque guidecomponent::SkeletonToFK (parm : Dict) (pa...

-- special function not supported yet
-- @[apex_node "guidecomponentutils::Add2BoneIKCore"]        
-- opaque guidecomponentutils::Add2BoneIKCore (pa...

-- special function not supported yet
-- @[apex_node "guidecomponentutils::AddComponentSkeletonCore"]        
-- opaque guidecomponentutils::AddCompo...
...
-- special function not supported yet
-- @[apex_node "ragdoll::AddMappingToControl"]        
-- opaque ragdoll::AddMappingToControl (parm : Dict) (va...
...
-- special function not supported yet
-- @[apex_node "ragdoll::Solve"]        
-- opaque ragdoll::Solve (parm : GeometryArray) (parm : GeometryArray)...
...
-- special function not supported yet
-- @[apex_node "rig::AbstractControl"]        
-- opaque rig::AbstractControl (xform : Matrix4) (x : Float) (y ...
...
-- special function not supported yet
-- @[apex_node "rig::ControlRigExtract"]        
-- opaque rig::ControlRigExtract (parm : Geometry) (parm : Ape...

-- special function not supported yet
-- @[apex_node "rig::ControlRigExtractSkel"]        
-- opaque rig::ControlRigExtractSkel (parm : Geometry) (pa...
...
-- special function not supported yet
-- @[apex_node "rig::CurveIK" has_rundata]        
-- opaque rig::CurveIK (curve : Geometry) (curvexform : Matr...
...
-- special function not supported yet
-- @[apex_node "rig::MultiBoneIK" has_rundata]        
-- opaque rig::MultiBoneIK {numin': Nat} (in' : Variadic...
...
-- special function not supported yet
-- @[apex_node "rig::SampleSplineTransforms" has_rundata]        
-- opaque rig::SampleSplineTransforms (geo : ...

-- special function not supported yet
-- @[apex_node "rig::SampleSplineTransforms::2.0" has_rundata]        
-- opaque rig::SampleSplineTransforms::2...

-- special function not supported yet
-- @[apex_node "rig::SampleSplineTransforms::3.0" has_rundata]        
-- opaque rig::SampleSplineTransforms::3...
...
-- special function not supported yet
-- @[apex_node "rig::SplineInterpolateTransforms" has_rundata]        
-- opaque rig::SplineInterpolateTransfor...

-- special function not supported yet
-- @[apex_node "rig::SplineInterpolateTransforms::2.0" has_rundata]        
-- opaque rig::SplineInterpolateTra...

-- special function not supported yet
-- @[apex_node "rig::SplineInterpolateTransforms::3.0" has_rundata]        
-- opaque rig::SplineInterpolateTra...
...
-- special function not supported yet
-- @[apex_node "rig::SplineOffsets" has_rundata]        
-- opaque rig::SplineOffsets (geo : Geometry) (primnum...
...
-- special function not supported yet
-- @[apex_node "skel::Blend" has_rundata]        
-- opaque skel::Blend (geo0 : Geometry) (auxgeo : GeometryArr...
...
-- special function not supported yet
-- @[apex_node "skel::GetPointLocalTransforms" has_rundata]        
-- opaque skel::GetPointLocalTransforms (ge...
...
-- special function not supported yet
-- @[apex_node "skel::GetPointTransforms" has_rundata]        
-- opaque skel::GetPointTransforms (geo : Geomet...
...
-- special function not supported yet
-- @[apex_node "skel::SetTransformObjectRest" has_rundata]        
-- opaque skel::SetTransformObjectRest (grap...
...
-- special function not supported yet
-- @[apex_node "skel::UpdateJointTags"]        
-- opaque skel::UpdateJointTags (parm : StringArray) (value : G...

-- special function not supported yet
-- @[apex_node "skel::UpdateTransformObject"]        
-- opaque skel::UpdateTransformObject (input : Bool) (gra...

-- special function not supported yet
-- @[apex_node "skel::UpdateTransformObjects" has_rundata]        
-- opaque skel::UpdateTransformObjects (geo0...
...
-- special function not supported yet
-- @[apex_node "string::PathSplit"]        
-- opaque string::PathSplit (parm : String) (value : String) (value...
...
-- special function not supported yet
-- @[apex_node "transform::ClampedLookAtPorthole"]        
-- opaque transform::ClampedLookAtPorthole (parm : F...

-- special function not supported yet
-- @[apex_node "transform::ClampedLookAtWindow"]        
-- opaque transform::ClampedLookAtWindow (parm : Float...
...
-- special function not supported yet
-- @[apex_node "transform::MirrorTransform"]        
-- opaque transform::MirrorTransform (x : Float) (y : Floa...
...
-- special function not supported yet
-- @[apex_node "transform::ProjectOnSphere"]        
-- opaque transform::ProjectOnSphere (value : Vector3) (va...

-- special function not supported yet
-- @[apex_node "transform::ProjectOnSphericalPorthole"]        
-- opaque transform::ProjectOnSphericalPorthole...

-- special function not supported yet
-- @[apex_node "transform::ProjectOnSphericalWindow"]        
-- opaque transform::ProjectOnSphericalWindow (pa...
...
-- special function not supported yet
-- @[apex_node "transform::ViewScaling"]        
-- opaque transform::ViewScaling (value : Dict) (value : Matri...
