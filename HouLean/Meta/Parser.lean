...
This is updated version of Alloy/Util/Parser.lean by Mac Malone
https://github.com/tydeu/lean4-alloy/blob/be37dab91e3b0d62c64d180fa29ed3d3c4d8bf8b/Alloy/Util/Parser.lean
-/
import Lean.Parser
...
partial def lineFn : ParserFn := fun input s =>
  parseNormal input s
where
  parseNormal input s :=
